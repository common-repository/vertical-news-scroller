...
*   [Vertical News List Shortcode](http://blog.i13websolution.com/vertical-news-list-demo/)    



**Find Vertical News Scroller Pro Plugin (Unlimited News Categories + Much more fatures) at [Vertical News Scroller Pro](https://www.i13websolution.com/product/wordpress-vertical-news-scroller-pro/)**
...
2. Vertical News list(Without Scroll) shortcode.
3. Now pro version has two type news style modern(jquery scroller) and classic(marquee).
4. Pro version support shortcode so you can print it any where in WordPress.
5. Pro Version support Thumbnail Image
6. Pro Version support news order and also update mass news order.
7. Pro Version admin can set color of title and Description
8. Pro Version admin can set font size and Description
9. Admin can set any post or page as a news no need to add edit news manually.
10. Go to add or edit post or page and checkbox check add this post or page as news.
11. Go to add or edit post or page and checkbox check add this post or page as news.
12. Vertical News Scroller Open news link in same window Or In new tab
...
10.Pro Version News List (Without scroll)
